...
% Captured here so they can be passed into the local function
fwd_methods_cfg       = fwd_methods;
fwd_method_colors_cfg = fwd_method_colors;
...
if run_sensor
    ...
    run_disp_mode(rsq_by_method, loaded_methods, valid_keys_geom, ...
        ...
        method_label_map, fwd_methods_cfg, fwd_method_colors_cfg, ...
        pub_line_width, pub_marker_size, ...
...
function run_disp_mode(rsq_by_method, loaded_methods, valid_keys, ...
    ...
    src_range, src_spacing_mm, n_axes, distances, marker_idx, ...
    cervical_min_mm, cervical_max_mm, ...
    method_label_map, fwd_methods, fwd_method_colors, ...
    pub_line_width, pub_marker_size, ...
