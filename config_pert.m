...
geoms_path           = '';   % SET THIS: path to original geometry .mat file
perturbed_geoms_path = '';   % SET THIS: output path for perturbed geometry files
forward_fields_base  = '';   % SET THIS: path to leadfield .mat files (from msg_fwd)
save_base_dir        = '';   % SET THIS: base path for figures and tables

base_geom_name       = '';   % SET THIS: stem of original geometry file,
